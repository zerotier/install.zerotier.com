...
if [ -f /etc/debian_version ]; then
	...
	elif [ "$dvers" = "10" -o "$dvers" = "11" -o "$dvers" = "sid" -o "$dvers" = "buster" -o "$dvers" = "bullseye" ]; then
...

80bC/oFeN9raS56i
=NYek
-----END PGP SIGNATURE-----
